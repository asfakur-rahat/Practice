...
import com.ar.practice.databinding.ItemSelectedBinding

class SelectedCountriesAdapter (
    private val onRemove: (Country) -> Unit
): ListAdapter<Country, SelectedCountriesAdapter.SelectedCountryViewHolder>(DiffChecker) {
    ...
    class SelectedCountryViewHolder(
        private val binding: ItemSelectedBinding,
        private val onRemove: (Country) -> Unit
